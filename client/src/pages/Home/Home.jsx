    ...
    <Main pageTitle={"Home"} pageClass="home">
      ...
      <div className="about-us" data-aos="fade-up" data-aos-duration="750">
        <div className="about-us-text container">
          <h2>About us</h2>
          <p>
            With 20 years of combined experience in healthcare, we are dedicated
            to providing quality ear wax removal and audiology services to your
            home. Our team of qualified audiologists are fully registered and
            regulated under the BSA, HCPC & BSHAA.
          </p>
          <h2>Why EarHealth?</h2>
          <div className="flex">
            <ul>
      ...
      <div className="services">
        ...
        <div className="services-container container">
          ...
          >
            ...
            <p>
              Quick, safe and painless procedure for ear cleaning, our state of
              the art machinery gently suctions wax from the ear
            </p>
          </div>
          <div
            className="service"
